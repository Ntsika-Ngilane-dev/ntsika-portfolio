...
const projects: Project[] = [
  ...
  {
    id: 2,
    title: "OddJobs Marketplace",
    shortDescription: "Full-stack marketplace platform connecting service providers with customers",
    fullDescription:
      "A comprehensive marketplace platform that revolutionizes the gig economy by seamlessly connecting service providers with customers seeking various odd jobs and services. The application features a sophisticated matching algorithm, secure payment processing, real-time communication system, and comprehensive user management. Built with a modern tech stack focusing on scalability, security, and user experience, the platform handles everything from simple household tasks to complex professional services.",
    techStack: ["React", "Next.js", "TypeScript", "Tailwind CSS", "Node.js", "Express.js", "MongoDB", "Mongoose", "JWT", "Stripe API", "Socket.io", "Cloudinary", "Vercel"],
    category: "Full-Stack",
    ...
    challenges: [
      "Implementing dual user roles (service providers and customers) with different permissions",
      "Building a real-time bidding system with live updates and notifications",
      "Integrating secure payment processing with Stripe while handling disputes and refunds",
      "Designing a scalable MongoDB schema for complex relationships between users, jobs, and bids",
      "Implementing real-time messaging with Socket.io for seamless communication",
      "Creating a sophisticated job matching algorithm based on location, skills, and ratings",
      "Handling file uploads for job images and user profiles with Cloudinary integration",
      "Building a comprehensive review and rating system with fraud prevention",
      "Implementing JWT-based authentication with refresh tokens and role-based access control",
      "Optimizing performance for large datasets and concurrent users",
      "Ensuring responsive design across all device types and screen sizes",
      "Managing complex state management for real-time updates across multiple components",
    ],
    outcomes: [
      "Successful marketplace launch",
      "Active user engagement",
      "Seamless job matching system",
